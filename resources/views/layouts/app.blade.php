...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link href="{{ asset('assets/libs/sweetalert2/sweetalert2.min.css', true) }}" rel="stylesheet" type="text/css"/>
...
{{--        @include('includes.right-bar')--}}
        ...
        <script src="{{ asset('assets/libs/sweetalert2/sweetalert2.min.js', true) }}"></script>
